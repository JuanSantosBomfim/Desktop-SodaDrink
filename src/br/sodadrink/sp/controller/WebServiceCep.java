 ...
 * {@link WebServiceCep#searchCep(String)} para maiores informa��es. <BR>
 * <BR>
 * Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do m�todo estatico
 * {@link WebServiceCep#searchCep(String)}. <BR>
 * <BR>
 * Objeto contem todas as informa��es do XML, al�m de informa��es
 * referente ao resultado da pesquisa. <BR>
 * <BR>
 ...
 * <a href="http://www.dom4j.org/dom4j-1.6.1/download.html" target=
 * "_blank">dom4j.org</a> <BR>
 * <BR>
 * Exemplo de uso: <BR>
...
public final class WebServiceCep {
	...
	/**
	 * Classe utilit�ria apenas encapsula o Iterator de elements da root
	 * dentro de um Iterable, para ser usado dentro de um for.
	 * 
	 * @see Iterable
	 * @see Iterator
	 * @author Tomaz Lavieri
	...
	private static final class XmlEnums {
		...
		/**
		 * Busca um Enum {@link Xml} a partir do seu nome, a busca n�o �
		 * case sensitive, portanto o nome pode ser escrito ignorando lowercases
		 * or uppercases.
		 * 
		 * @see Xml
		 * @param xmlName
	...
	/**
	 * Mascara para a string url de conex�o, onde <tt>"%s"</tt> �
	 * substituido pelo valor do cep.
	 */
	 ...
	 *             Quando h� problema na forma��o do documento XML.
	 * @throws MalformedURLException
	 *             Quando a h� problema no link url.
	 */
	 ...
	 * <BR>
	 * Por exemplo: <BR>
	 * <tt>for (Element e : getElements(cep)) { <BR>
	 * //... <BR>
	 * }
	 * 
	 * @param cep
	 ...
	 * <a href="http://www.republicavirtual.com.br" target=
	 * "_blank">republicavirtual.com.br</a>, retornando o resultado em um objeto
	 * {@link WebServiceCep}. <BR>
	 * <BR>
	 * N�o se faz necess�rio formata��es, a string pode ser enviada em
	 * qualquer formata��o, pois s� ser�o consideradas os primeiros 8
	 * numeros da string. <BR>
	 * Por Exemplo: <BR>
	 * Uma <tt>{@link String} "14.568-910"</tt> � automaticamente passada para
	 * <tt>"14568910"</tt>. <BR>
	 * Uma <tt>{@link String} "1%4#5?55%16a8&910"</tt> � automaticamente
	 * passada para <tt>"14555168"</tt>, s� levando em conta os primeiros 8
	 * n�meros.
	 * 
	 * @param cep
	 *            N�mero do cep a ser carregado. S� ser�o considerados os
	 *            primeiros 8 n�meros da {@link String} enviada. Todos os
	 *            caracters n�o num�ricos ser�o removidos, e a string
	 *            ser� truncada caso seja maior que 8 caracters.
	...
	/*
	 * PRIVATE m�todos set, usados pela classe Xml para setar o objeto
	 * CepWebService
	 */
	 ...
	 */
	/**
	 * Informa o c�digo do resultado da pesquisa. <BR>
	 * C�digos conhecidos: <BR>
	 * <tt>-1</tt> : busca n�o realizada <BR>
	 * <tt>0</tt> : cep n�o encontrado <BR>
	 * <tt>1</tt> : cep econtrado <BR>
	 * <tt>-14</tt> : Site n�o encontrado (pode ser por problemas na
	 * internet). <BR>
	 * <tt>-15</tt> : N�o foi possivel ler o documento xml <BR>
	 * <tt>-16</tt> : Erro na forma��o da url <BR>
	 ...
	 * 		<tt>false</tt> - caso haja falhas, ou o cep enviado n�o esteja
	 *         cadastrado.
	 */
	 ...
	 * 
	 * @return <tt>true</tt> - Caso o cep n�o tenha cido encontrado. <BR>
	 ...
	 * 		<tt>false</tt> - Caso n�o haja falhas.
	 */
	...
	/**
	 * Pega a exce��o que ocorreu durante a busca, retorna null caso n�o
	 * haja exce��es.
	 * 
	 * @return <tt>{@link Exception}</tt> - Caso ocorra falhas <BR>
	 * 		<tt>null</tt> - Caso n�o haja falhas.
	 */
